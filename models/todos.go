...
var (
	todoAllColumns            = []string{"id", "user_id", "title", "done", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"user_id", "title", "created_at", "updated_at"}
	todoColumnsWithDefault    = []string{"id", "done"}
